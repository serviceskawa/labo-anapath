            ...
            <form action="{{ route('test_order.store') }}" method="post" autocomplete="off"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select select2" data-toggle="select2" required id="type_examen"
                            name="type_examen">
                            <option value="" disabled selected>Sélectionner le type d'examen</option>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="examenReferenceInputInterne mt-3" style="display: none !important">
                            ...
                            <select class="form-select select2" data-toggle="select2" id="examen_reference_select"
                                ...
                                <option value="{{ $test_order->id }}">{{ $test_order->code }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select select2" data-toggle="select2" name="patient_id" id="patient_id"
                            required>
                            <option value="" disabled selected>Sélectionner le nom du patient</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select select2" data-toggle="select2" name="doctor_id" id="doctor_id"
                            required>
                            <option value="" disabled selected>Sélectionner le médecin traitant</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" data-toggle="select2" name="hospital_id" id="hospital_id" required>
                            <option value="" disabled selected>Sélectionner le centre hospitalier de provenance</option>
