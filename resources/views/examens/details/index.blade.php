                ...
                <div class="card-body">
                                ...
                                @if ($report_search->status == 0)
                                    <select class="form-select select2" data-toggle="select2" required name="contrat_id"
                                        ...
                                        @forelse ($contrats as $contrat)
                                            @if ($contrat->status == 'ACTIF' && $contrat->invoice_unique == 1 && $contrat->is_close == 0)
                                                @php
                                ...
                                @else
                                    @foreach ($contrats as $contrat)
                                        @if ($test_order->contrat_id == $contrat->id)
                                            <input type="text" id="contrat_id" class="form-control" readonly
                                                value="{{ $contrat->name }}">
                                ...
                                @else
                                    @foreach ($patients as $patient)
                                        @if ($test_order->patient_id == $patient->id)
                                            ...
                                            <input type="text" name="patient_id" id="patient_id" class="form-control"
                                                readonly value="{{ $patient->id }}" hidden>
                                        @endif
                                    @endforeach
                                @endif
                            @else
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if ($report_search)
                                    <input type="text" {{ $report_search->status == 1 ? 'readonly' : '' }}
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            @if ($report_search)
                                <input type="date" {{ $report_search->status == 1 ? 'readonly' : '' }}
                                        ...
                                        @foreach (getUsersByRole('docteur') as $item)
                                            @if ($test_order->attribuate_doctor_id == $item->id)
                                                ...
                                                <input type="text" name="attribuate_doctor_id" id=""
                                                    class="form-control" readonly value="{{ $item->id }}" hidden>
                                            @endif
                                        @endforeach
                            ...
                            @if ($report_search)
                                <input type="checkbox" id="switch3" {{ $report_search->status == 1 ? 'readonly' : '' }}
                                    class="form-control" name="is_urgent"
                ...
                <div class="card-body">
                    <form action="{{ route('test_order.createimagegallerie', $test_order->id) }}" method="POST"
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-md-11">
                                <input class="form-control" type="file" name="files_name[]" id="formFileMultiple"
                                    multiple>
                            </div>
                            <div class="col-md-1">
