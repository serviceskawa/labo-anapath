            ...
            <div class="card-body">
                ...
                <div class="col-md-12 my-3">
                    ...
                    <div class="examenReferenceInputInterne mt-3" style="display: none !important">
                        ...
                        <select class="form-select select2" data-toggle="select2" required id="examen_reference_select"
                            ...
                            <option value="{{ $TestOrder->id }}" {{ $TestOrder->code == $test_order->test_affiliate ?
                                'selected' : '' }}>{{ $TestOrder->code }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="doctor_id" id="doctor_id" class="form-control" readonly
                            value="{{ $doctor->name }}">
                        @endif
                        @endforeach
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select name="attribuate_doctor_id" id="" class="form-control">
                            ...
                            <option value="{{ $item->id }}" {{ $test_order->attribuate_doctor_id == $item->id ?
                                'selected' : '' }}>
