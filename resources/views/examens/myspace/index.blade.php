            ...
            <div class="col-lg-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Orders">CAS AFFECTES</h5>
            ...
            <div class="col-lg-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Orders">CAS EN ATTENTE</h5>
            ...
            <div class="col-lg-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Orders"> <a href="#casterminer" style="text-decoration : none; color:inherit;"> CAS TERMINES </a></h5>
            ...
            <div class="col-lg-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Orders">CAS URGENTS</h5>
            ...
            <div class="col-lg-4">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0" title="Number of Orders">CAS EN RETARDS</h5>
