    ...
    <div class="modal-dialog">
        ...
        <form action="{{ route('examens.store') }}" method="POST" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="example-select" class="form-label">Catégorie parente<span style="color:red;">*</span></label>
                ...
                <div class="mb-3">
                    <label for="simpleinput" class="form-label">Nom de l'examen<span style="color:red;">*</span></label>
