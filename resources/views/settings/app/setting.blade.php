                        ...
                        <div class="card-body tab-content b-0 mb-0">
                                ...
                                <form action="{{route('settings.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div id="basicwizard5">
                                        ...
                                        <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                            <li class="nav-item">
                                                <a href="#general1" id="generalLi" data-bs-toggle="tab"
                                    ...
                                    <div style="padding-bottom: 10px;padding-top:10px">
                                        <button type="submit" class="btn btn-primary">Enrégistrer <i
                                                class="mdi mdi-check-all"></i></button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="tab-pane" id="basictab2">
                                <form action="{{route('settings.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                placeholder="Emails alerte aux techniciens"
                                    ...
                                    <div class="mb-3">
                                        <label for="example-select" class="form-label">Roles<span
                                                style="color:red;">*</span></label>
                                        <select class="form-select select2" data-toggle="select2" required
                                            name="services[]" multiple>
                                            <option>Sélectionner les services</option>
                                            @php
                                            $selectedServices = explode('|', $service->value);
                                            @endphp
                                            <option value="remboursement" {{ in_array("remboursement",
                                                $selectedServices) ? 'selected' :'' }}>Service de demande de
                                                remboursement</option>
                                            <option value="boncaisse" {{ in_array("boncaisse", $selectedServices)
                                                ? 'selected' :'' }}>Service de bon de caisse</option>
                            ...
                            <div class="tab-pane" id="basictab3">
                                <form action="{{route('settings.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div style="padding-bottom: 10px;padding-top:10px">
                                        <button class="btn btn-primary">Enrégistrer <i
                                                class="mdi mdi-check-all"></i></button>
                                    </div>
                                </form>
                            </div>
