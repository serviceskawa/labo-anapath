    ...
    <div class="card">
        <div class="card-body">
            <div class="row" id="basicwizard">
                ...
                <div class="col-3">
                    <ul class="mb-4" style="display: grid">
                        <li class="side-nav-item">
                            <a href="#basictab1" id="general" data-bs-toggle="tab" data-toggle="tab"
                        ...
                        <li class="side-nav-item">
                            <a href="#basictab2" id="email" data-bs-toggle="tab" data-toggle="tab"
                                class="nav-link rounded-0 pt-2 pb-2">
                        ...
                        <li class="side-nav-item">
                            <a href="#basictab3" id="mobile" data-bs-toggle="tab" data-toggle="tab"
                                class="nav-link rounded-0 pt-2 pb-2">
                        ...
                        <li class="side-nav-item">
                            <a href="#basictab5" id="mobile" data-bs-toggle="tab" data-toggle="tab"
                                class="nav-link rounded-0 pt-2 pb-2">
                                <i class="mdi mdi-checkbox-marked-circle-outline me-1"></i>
                        ...
                        <li class="side-nav-item">
                            <a href="#basictab4" id="bank" data-bs-toggle="tab" data-toggle="tab"
                                class="nav-link rounded-0 pt-2 pb-2">
                ...
                <div class="col-9">
                    <div class="col-12 bg-primary rounded-top"
                        style="padding-left: 50px; padding-bottom: 15px; padding-top: 15px">
                        <div class="page-title-box">
                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select select2" data-toggle="select2"
                                        name="show_signator_invoice">
                                        <option>OUI/NON</option>
                                        <option value="OUI"
                                            {{ $show_signator_invoice->value=="OUI" ? 'selected' : '' }}>OUI</option>
                                        <option value="NON"
                                            {{ $show_signator_invoice->value=="NON" ? 'selected' : '' }}>NON</option>
                                    </select>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" id="simpleinput" placeholder="Cle de paiement"
                                            value="{{ $token_payment->value ?? '' }}" name="token_payment"
                                            class="form-control">
                                    </div>
                                </div>
                                <div style="padding-bottom: 10px;padding-top:10px">
                            ...
                            <form action="{{ route('settings.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div id="basicwizard5">
                                    ...
                                    <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                        <li class="nav-item">
                                            <a href="#general1" id="generalLi" data-bs-toggle="tab" data-toggle="tab"
                                                class="nav-link rounded-0 pt-2 pb-2">
                                                <i class="mdi mdi-account-circle me-1"></i>
                                                <span class="d-none d-sm-inline">Général</span>
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a href="#general2" id="logo" data-bs-toggle="tab" data-toggle="tab"
                                                class="nav-link rounded-0 pt-2 pb-2">
                                                        ...
                                                        <div class="col-6 mb-3">
                                                            <div class="input-group flex-nowrap">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $app_name->value }}" aria-label="name"
                                                                    name="app_name" aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                        <div class="col-6 mb-3">
                                                            <div class="input-group flex-nowrap">
                                                                <span class="input-group-text" id="basic-addon1"><i
                                                                        class="mdi mdi-comment-edit"></i></span>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Devise" value="{{ $devise->value }}"
                                                                    aria-label="devise" name="devise"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6 mb-3">
                                                            <div class="input-group flex-nowrap">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $adress->value }}" placeholder="Adresse"
                                                                    aria-label="adress" name="adress"
                                                                    aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                        <div class="col-6 mb-3">
                                                            <div class="input-group flex-nowrap">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $phone->value }}" placeholder="Téléphone"
                                                                    aria-label="telephone" name="phone"
                                                                    aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6 mb-3">
                                                            <div class="input-group flex-nowrap">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $email->value }}" placeholder="Email"
                                                        ...
                                                        <div class="col-6 mb-3">
                                                            <div class="input-group flex-nowrap">
                                                                <span class="input-group-text" id="basic-addon1"><i
                                                                        class="mdi mdi-web"></i></span>
                                                                <input type="text" class="form-control"
                                                                    value="{{ $web_site->value }}"
                                                                    placeholder="Site web" aria-label="web_site"
                                                                    name="web_site" aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <!-- Début ifu et whatsapp number -->
                                                    <div class="row">
                                                        <div class="col-6 mb-3">
                                                            <div class="input-group flex-nowrap">
                                                                <span class="input-group-text" id="basic-addon1"><i
                                                        ...
                                                        <div class="col-6 mb-3">
                                                            <div class="input-group flex-nowrap">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    ...
                                                                    aria-label="whatsapp_number" name="whatsapp_number"
                                                                    aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- Fin ifu et whatsapp number -->
                                                    <div class="row">
                                                        <div class="mb-3 col-md-6">
                                                            <div class="input-group flex-nowrap">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    name="footer" aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            <div class="input-group flex-nowrap">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $rccm->value }}" placeholder="RCCM"
                                                                    aria-label="rccm" name="rccm"
                                                                    aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <form action="{{ route('settings.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-4 mb-3">
                                        ...
                                        <input type="text" id="simpleinput" name="email_host"
                                            value="{{ $email_host->value ?? '' }}" class="form-control">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label for="simpleinput" class="form-label">Port </label>
                                        <input type="text" id="simpleinput" name="email_port"
                                            value="{{ $email_port->value ?? '' }}" class="form-control">
                                    </div>
                                    <div class="col-4 mb-3">
                                        <label for="simpleinput" class="form-label">Nom d'utilisateur</label>
                                        <input type="text" id="simpleinput" value="{{ $username->value ?? '' }}"
                                            name="username" class="form-control">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="simpleinput" class="form-label">Mot de passe</label>
                                        <input type="password" id="simpleinput" value="{{ $password->value ?? '' }}"
                                            name="password" class="form-control">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="simpleinput" class="form-label">Chiffrement</label>
                                        <input type="text" id="simpleinput" value="{{ $encryption->value ?? '' }}"
                                            name="encryption" class="form-control">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="simpleinput" class="form-label">Adresse de
                                            l'expéditeur</label>
                                        <input type="text" id="simpleinput" value="{{ $from_adresse->value ?? '' }}"
                                            name="from_adresse" class="form-control">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="simpleinput" class="form-label">Nom de l'expéditeur</label>
                                        <input type="text" id="simpleinput" value="{{ $from_name->value ?? '' }}"
                                ...
                                <div class="mb-3">
                                    <div class="col-md-12 mb-3">
                                        <label for="simpleinput" class="form-label">Emails alerte techniciens
                                        </label>
                                        <input type="text" id="simpleinput" placeholder="Emails alerte aux techniciens"
                                            value="{{ $email_technician->value ?? '' }}" name="email_technician"
                                            class="form-control">
                                    </div>
                                </div>

                                {{-- <div class="mb-3">
                                        <label for="example-select" class="form-label">Roles<span
                                                style="color:red;">*</span></label>
                                        <select class="form-select select2" data-toggle="select2" name="mails[]"
                                            multiple>
                                            ...
                                            @endphp
                                            <option value="{{$user->email}}" {{in_array($user->email, $selectedMails) ?
                                                'selected' : ''}} >{{$user->email}}</option>
                                @endforeach
                                </select>
                        </div> --}}
                        ...
                        <div class="mb-3">
                            <label for="example-select" class="form-label">Roles<span
                                    style="color:red;">*</span></label>
                            <select class="form-select select2" data-toggle="select2" required name="services[]"
                                multiple>
                                ...
                                <option value="remboursement"
                                    {{ in_array('remboursement', $selectedServices) ? 'selected' : '' }}>
                                    Service de demande de
                                    remboursement</option>
                                <option value="boncaisse"
                                    {{ in_array('boncaisse', $selectedServices) ? 'selected' : '' }}>
                                    Service de bon de caisse</option>
                                <option value="ticket" {{ in_array('ticket', $selectedServices) ? 'selected' : '' }}>
                                    Service de signaler un problème</option>
                                <option value="conge" {{ in_array('conge', $selectedServices) ? 'selected' : '' }}>
                                    Service de demande de congé</option>
                            </select>
                        </div>
                        <div style="padding-bottom: 10px;padding-top:10px">
                            <button class="btn btn-primary">Enregistrer <i class="mdi mdi-check-all"></i></button>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right mr-3">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#standard-modal">Ajouter une nouvelle
                                            banque</button>
                                    </div>
                    ...
                    <div class="tab-pane" id="basictab5">
                        ...
                        <div id="basicwizard5">
                            <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                <li class="nav-item">
                                    <a href="#general3" id="generalcr" data-bs-toggle="tab" data-toggle="tab"
                                        class="nav-link rounded-0 pt-2 pb-2">
                                        <i class="mdi mdi-account-circle me-1"></i>
                                        <span class="d-none d-sm-inline">Général</span>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="#general4" id="titre" data-bs-toggle="tab" data-toggle="tab"
                                        class="nav-link rounded-0 pt-2 pb-2">
                                        <i class="mdi mdi-face-profile me-1"></i>
                                        ...
                                        <div class="row">
                                            <div class=" mb-3">
                                                <div class="input-group flex-nowrap">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ $report_footer->value }}" aria-label="report_footer"
                                                        name="report_footer" aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <div class="input-group flex-nowrap">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        placeholder="Revue du rapport" aria-label="report_review_title"
                                                        name="report_review_title" aria-describedby="basic-addon1">
                                                </div>
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Entete</label>
                                                <input class="form-control" type="file" name="entete"
                                                    id="inputGroupFile04">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    name="prefixe_code_demande_examen" aria-describedby="basic-addon1">
                                            </div>

                                            <div class="mb-3">
                                                <label for="simpleinput" class="form-label">Afficher la
                                                    signature<span style="color:red;">*</span></label>
                                                <select class="form-select select2" data-toggle="select2"
                                                    name="show_signator_invoice">
                                                    <option>OUI/NON</option>
                                                    <option value="OUI"
                                                        {{ $show_signator_invoice->value == 'OUI' ? 'selected' : '' }}>
                                                        OUI</option>
                                                    <option value="NON"
                                                        {{ $show_signator_invoice->value == 'NON' ? 'selected' : '' }}>
                                                        NON</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="page-title-box">
                                                <div class="page-title-right mr-3 mb-1">
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#standard-modal">Ajouter un nouveau
                                                        titre</button>
                                                </div>
                                                <h4 class="page-title"></h4>
                                            </div>
                                                ...
                                                <table id="datatable1"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>{{ $item->id }}</td>
                                                            <td
                                                                style="font-weight:{{ $item->status != 0 ? 'bold' : '' }}">
                                                                {{ $item->title }}
                                                                {{ $item->status != 0
                                                                                    ? '(Par
                                                                                                                                                        defaut)'
