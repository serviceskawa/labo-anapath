                            ...
                            <div class="card-body tab-content b-0 mb-0">
                                    ...
                                    <form action="{{ route('settings.store') }}" method="post"
                                        ...
                                        <div id="basicwizard5">
                                            ...
                                            <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#general2" id="logo" data-bs-toggle="tab"
                                                        data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-6 mb-3">
                                                                    <div class="input-group flex-nowrap">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            value="{{ $adress->value }}"
                                                                            placeholder="Adresse" aria-label="adress"
                                                                            name="adress"
                                                                            aria-describedby="basic-addon1">
                                                                    </div>
                                                                </div>
                                    ...
                                    <form action="{{ route('settings.store') }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 mb-3">
                                                <label for="simpleinput" class="form-label">Adresse de
                                                    l'expéditeur</label>
                                                <input type="text" id="simpleinput"
                                                    value="{{ $from_adresse->value ?? '' }}" name="from_adresse"
                                                    class="form-control">
                                            </div>
                                            <div class="col-6 mb-3">
                                                <label for="simpleinput" class="form-label">Nom de l'expéditeur</label>
                                                <input type="text" id="simpleinput"
                                                    value="{{ $from_name->value ?? '' }}" name="from_name"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select select2" data-toggle="select2" required
                                                ...
                                                <option value="ticket"
                                                    {{ in_array('ticket', $selectedServices) ? 'selected' : '' }}>
                                                    Service de signaler un problème</option>
                                                <option value="conge"
                                                    {{ in_array('conge', $selectedServices) ? 'selected' : '' }}>
                                ...
                                <div class="tab-pane" id="basictab5">
                                    ...
                                    <div id="basicwizard5">
                                        <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                            <li class="nav-item">
                                                <a href="#general3" id="generalcr" data-bs-toggle="tab"
                                                    data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                    <i class="mdi mdi-account-circle me-1"></i>
                                                    <span class="d-none d-sm-inline">Général</span>
                                                </a>
                                            ...
                                            <li class="nav-item">
                                                <a href="#general4" id="titre" data-bs-toggle="tab"
                                                    data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                    <i class="mdi mdi-face-profile me-1"></i>
                                                ...
                                                <div class="card mb-md-0 mb-3">
                                                    <div class="card-body">
                                                        <div class="card-widgets">
                                                            <a href="javascript:;" data-bs-toggle="reload"><i
                                                                    class="mdi mdi-refresh"></i></a>
                                                            <a data-bs-toggle="collapse" href="#cardCollpase1"
                                                                role="button" aria-expanded="false"
                                                                aria-controls="cardCollpase1"><i
                                                                    class="mdi mdi-minus"></i></a>
                                                            <a href="#" data-bs-toggle="remove"><i
                                                                    class="mdi mdi-close"></i></a>
                                                        </div>
