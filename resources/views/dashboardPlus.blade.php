                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap table-hover mb-0">
                            <tbody>
                                @for ($i = 0; $i < 7 && $i < count($examensDemandes); $i++) @php
                                    $examen=$examensDemandes[$i]; @endphp <tr>
                                    <td>
                                        {{ $i+1 }}
                                    </td>
                                    <td>
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center mt-5 py-2">
                        ...
                        <div class="col-6">
                            ...
                            <h3 class="fw-normal">
                                <span>{{ count($totalByStatus) > 1 ? $totalByStatus[0]->total : '' }}</span>
                            </h3>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="scroll-vertical-datatable"
                                                class="table table-sm table-centered mb-0 font-14">
                                                        ...
                                                        <td>
                                                            <div class="progress" style="height: 3px;">
                                                                <div class="progress-bar" role="progressbar"
                                                                    style="width: {{($patient->total_patients/$totalDemandesParHopitalCount)*100}}%; height: 20px;"
                            ...
                            <div class="col-xl-4 col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="scroll-vertical-datatable1"
                                                class="table table-sm table-centered mb-0 font-14">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th>Médécin</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="progress" style="height: 3px;">
                                                                <div class="progress-bar" role="progressbar"
                                                                    style="width: {{ ($medecin->total_patients/$totalDemandesParMedecinCount)*100 }}%; height: 20px;"
                                                                    aria-valuenow="{{$medecin->total_patients}}"
                                                                    aria-valuemin="0"
                                                                    aria-valuemax="{{$totalDemandesParMedecinCount}}">
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="progress" style="height: 3px;">
                                                                <div class="progress-bar" role="progressbar"
                                                                    style="width: {{($type->total_patients/$totalDemandesParTypeCount)*100}}%; height: 20px;"
                                                                    aria-valuenow="{{$type->total_patients}}"
                                                                    aria-valuemin="0"
                                                                    aria-valuemax="{{$totalDemandesParTypeCount}}">
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $testOrderToday->patient->lastname }}
                                        {{ $testOrderToday->patient->firstname }}
                                    </td>
                                    <td class="table-action">
                                        ...
                                        @else
                                        <a type="button" href="{{ route('report.show', $testOrderToday->id) }}"
                                            class="btn btn-warning" title="Compte rendu"><i
                                                class="uil-file-medical"></i> </a>
                                        @endif
                                        ...
                                        <a type="button"
                                            ...
                                            class="btn btn-success" title="Facture"><i class="mdi mdi-printer"></i> </a>
                                        @else
                                        <a type="button"
                                        ...
                                        <a type="button" target="_blank"
                                            ...
                                            class="btn btn-warning" title="Imprimer le compte rendu"><i
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <p><b>{{$totalByStatusForDoctor ? count($totalByStatusForDoctor)>1 ? $totalByStatusForDoctor[1]['total'] :'' :''}}</b>
                        Demandes d'examen terminées sur {{$testOrdersByDoctorCount}} </p>
                        ...
                        <table id="scroll-vertical-datatable"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span> {{$test->code}} </span>
                                        <a href="{{route('details_test_order.index',$test->id)}}"
                                            style="color: rgb(126, 122, 122)"><i class="mdi mdi-eye"></i></a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @endswitch
                                        <a type="button" href="{{route('report.show', $test->report->id)}}"
                                            title="Compte rendu"><i class="uil-file-medical"></i> </a>
                                    </td>
                                </tr>
                                @endforeach
                                @endif
                        ...
                        <div class="col-md-5">
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-4">
                                    ...
                                    <h5> Patient : {{$appointment->patient->firstname}}
...
<script>
var baseUrl = "{{ url('/') }}";
var statusTestOrder = @json($totalByStatus);
var totalByStatusForDoctor = @json($totalByStatusForDoctor);
</script>
