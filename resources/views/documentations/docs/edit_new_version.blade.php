<div class="modal fade" id="bs-example-modal-lg-edit-new-version-{{ $doc->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('doc.store') }}" method="POST" autocomplete="on"
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="first_doc_id" value="{{$doc->id}}">
                        <div class="row">
