                    ...
                    <div class="col-xxl-4 col-lg-5">
                        <div class="card">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4">Veillez remplir le formulaiore pour créer un compte utilisateur</p>
                                </div>

                                <form action="#">

                                    <div class="mb-3">
                                        <label for="emailaddress" class="form-label">Nom & Prénom</label>
                                        <input class="form-control" type="text" name="name" id="emailaddress" required="" placeholder="Entrer votre nom et prénom">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="password" name="password_confirmation" id="emailaddress" required="" placeholder="Entrer à nouveau le mot de passe">
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Vous souhaitez retourner à la page de connexion ? <a href="{{ route('login') }}" class="text-muted ms-1"><b>Connexion</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
