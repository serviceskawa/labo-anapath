            ...
            <div class="card mb-md-0 mb-3">
                <div class="card-body">
                    ...
                    {{-- <button type="button" data-bs-toggle="modal"
                        ...
                        <button type="button" data-bs-toggle="modal"
                            data-bs-target="#bs-example-modal-lg-show-{{ $item->id }}" class="btn btn-primary"><i
                                class="mdi mdi-eye"></i> </button>
                        <a href="{{route('daily.print',$item->id)}}" class="btn btn-warning"><i class="mdi mdi-printer"></i>
                        </a>
                        </td>
                        <td>{{ $key + 1 }}</td>
                        {{-- <td>{{ $item->id }}</td> --}}
