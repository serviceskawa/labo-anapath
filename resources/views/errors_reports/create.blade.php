        ...
        <div class="card-body">
            ...
            <form action="{{route('probleme.report.store')}} " method="post" autocomplete="off"
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="" rows="6" class="form-control" placeholder="Veuillez fournir plus de détails que possible pour nous permettre de mieux vous aider" required></textarea>
                    </div>
                </div>
        </div>
