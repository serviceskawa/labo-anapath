            ...
            <div class="card-body">
                ...
                <form action="{{ route('probleme.report.update') }} " method="post" autocomplete="off"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label for="exampleFormControlInput1" class="form-label mt-3">Status</label><br>
                            <p id="oldStatus">{{$ticket->status}} <button type="button" id="openSelect" style="border:none; background:white"><i class="mdi mdi-square-edit-outline"></i></button></p>
                            ...
                            <div class="d-flex">
                                ...
                                <button id="closeSelect" type="button" style="display: none; border:none; background:white"><i class="mdi mdi-close"></i></button>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="subject" placeholder="Entrer une description" id="" value="{{$ticket->subject}}"
                            class="form-control">
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            <label for="simpleinput" class="form-label">Joindre un fichier </label>
                        </div>
                    </div>

                    <div class="py-2 px-2 d-flex align-content-between justify-content-between">
                        @if ($user_role || $ticket->user_id == Auth::user()->id)
                            <a href="{{route('probleme.report.destroy',$ticket->id)}}" class="btn btn-light text-danger">Supprimer</a>
                        @endif
                        ...
                        {{-- <form class="needs-validation" novalidate="" name="chat-form" id="chat-form"> --}}
                            <div class="row">
                                <div class="col mb-2 mb-sm-0">
                                    ...
                                    <input type="text" id="message" class="bg-light form-control border-0" placeholder="Ecrivez un commentaire" required="">
                                ...
                                <div class="col-sm-auto">
                                    <div class="btn-group">
                                        <div class="d-grid">
                                            <button type="submit" id="chat-button" class="btn btn-success chat-send"><i class='uil uil-message'></i></button>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
                            </div> <!-- end row-->
