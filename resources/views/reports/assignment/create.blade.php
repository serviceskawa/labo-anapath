        ...
        <div class="card my-3">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <select class="form-select select2" data-toggle="select2" name="user_id" id="user_id" required>
                            ...
                            <option value="{{ $doctor->id }}" {{ $assignment->user_id == $doctor->id ? 'selected' :'' }}
                ...
                <div class="row px-2">
                    ...
                    <textarea name="note_assignment" class="form-control" id="" cols="30"
                        rows="5">{{ $assignment->note }}</textarea>
                </div>
            </div>
        </div>
