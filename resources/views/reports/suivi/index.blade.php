    ...
    <div class="card mb-md-0 mb-3" id="demandes">
        <div class="card-body">
            ...
            <div id="cardCollpase1" class="show collapse pt-3">
                ...
                <table id="datatablesuivi" class="dt-responsive nowrap w-100 table">
                    <thead>
                        <tr>
                            <th>Date</th>
                            <th>Code</th>
                    ...
                    <table class="table table-centered w-100 dt-responsive nowrap" id="">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td>Réalisé : {{ $macro->pathology }} <br> Non Réalisé : {{ $exam->total_general -
                                    $macro->pathology }}</td>
                                ...
                                <td>
                                    ...
                                    En attente : {{ $exam->total_general - $patient->called }} <br> Informé : {{
                                    $patient->called }}
                                    @endforeach
                                </td>
                                <td>
