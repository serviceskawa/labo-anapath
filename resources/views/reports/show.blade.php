        ...
        <form class="row" action="{{ route('report.store') }}" id="reportForm" method="post">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" id="editor" class="form-control mb-3" cols="30" rows="50"
                                        style="height: 500px;">{{ $report->description }}</textarea>
            ...
            <div class="col-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select select2" data-toggle="select2" name="tags[]" id="tag_id"
                                ...
                                @forelse ($tags as $tag)
                                <option value="{{ $tag->id }}" {{ $report->hasTag($tag->name) ? 'selected' : '' }}>
                                    {{ $tag->name }}</option>
                ...
                <div class="card mb-md-0 mb-3 mt-3">
                    ...
                    <div class="card-body">
                        <p><b>Nom</b> : {{ DB::table('patients')->where('id',
                            $test_order->patient_id)->value('lastname') }} {{ DB::table('patients')->where('id',
                            $test_order->patient_id)->value('firstname') }}</p>
                        <p><b>Code patient</b> : {{ DB::table('patients')->where('id',
                            $test_order->patient_id)->value('code')}}</p>
                        <p><b>Téléphone</b> : {{ DB::table('patients')->where('id',
                            $test_order->patient_id)->value('telephone1') }}</p>
                    </div>
                </div>
