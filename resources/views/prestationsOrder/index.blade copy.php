...
<div class="row">
 ...
 <div class="">
    ...
    <div class="page-title-box">
        ...
        <h4 class="page-title">Demandes de Prestations</h4>
    </div>
    <!----MODAL---->
    ...
    <div class="card mb-md-0 mb-3">
        <div class="card-body">
            ...
            <h5 class="card-title mb-0">Liste des demandes de prestations </h5>
                ...
                {{-- <form method="post" id="filter_form">
                    ...
                    <div class="row mb-3">
                     ...
                     {{--   <div class="col-lg-3">
                            ...
                            <div class="mb-3">
                                <label for="example-fileinput" class="form-label">Patients</label>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="mb-3">
                                <label for="example-fileinput" class="form-label">Prestations</label>
                                <select name="contrat_id" id="contrat_id" class="form-control">
                        ...
                        <div class="col-lg-3">
                            <div class="">
                                <button type="submit" class="btn btn-primary mt-3" id="add_detail">Ajouter</button>
                            </div>
                        </div>
                    ...
                    <div class="row d-flex align-items-end">
                        ...
                        <div class="col-md-4 col-12">
                         ...
                         <div class="col-md-4 col-12">
                            <div class="mb-3">
                                 <label for="example-fileinput" class="form-label">Prestations</label>
                                <select name="prestation_id" id="prestation_id"class="form-select select2" data-toggle="select2" required onchange="getPrestation()">
                                    <option value="">Tous les Prestations</option>
                                    @forelse ($prestations as $prestation)
                                    <option value="{{$prestation->id}}">{{$prestation->name}}</option>
                                    @empty
