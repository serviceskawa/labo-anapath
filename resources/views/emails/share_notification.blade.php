	...
	<head>
		...
		<title>Notification de document partagé</title>
		<style type="text/css">
			/* RESET STYLES */
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:25px;font-weight:normal;margin-bottom:5px;text-align:center;">Document partagé</h1>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
