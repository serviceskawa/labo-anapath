                                                        ...
                                                        <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td align="center" valign="top" class="textContent">
                                                                    <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:25px;font-weight:normal;margin-bottom:5px;text-align:center;">Demande de congé</h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- // CONTENT TABLE -->
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" class="textContent">
                                                                                <div style="text-align:justify;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                                                                    <p>Bonjour ,</p> <br>
                                                                                    <p>
                                                                                        Vous recevez cette notification parce que Mr/Mme {{ $data['user_name'] }} fait une demande de congé
                                                                                        Le dit congé débute le {{$data['start_date']}} et prend fin le {{$data['end_date']}}
                                                                                    </p>
                                                                                    <p>Merci,</p>
                                                                                    <p> {{$lab['value']}} </p>
                                                                                </div>
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top">
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            <td valign="top" class="textContent">
                                                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">Si vous n'avez pas demandé cet e-mail, il n'y a pas lieu de s'inquiéter - vous pouvez l'ignorer en toute
                                                                                    sécurité.</div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
