    ...
    <div class="modal-dialog">
        ...
        <form action="{{ route('supplier.categories.update') }}" method="POST" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="simpleinput" class="form-label">Nom de la catégorie</label>
                    <input type="text" name="name"  id="name2" class="form-control">
                </div>

                <div class="mb-3">
                    <label for="simpleinput" class="form-label">Descriptio</label>
...
<div id="editModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
    ...
    <div class="modal-dialog" style="max-width: 100%; padding-left: 300px; margin-left:50px;">
        <div class="modal-content" style="width: 70%;;">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel">Ajouter dans la caisse de vente</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <form action="{{route('cashbox.vente.update')}}" method="POST" autocomplete="off">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-6">
                            ...
                            {{-- <input type="text" id="bank_name2" class="form-control" required>
                            <input type="hidden" name="bank_id" id="bank_id2" class="form-control"> --}}
                        </div>
                        <div class="mb-3 col-lg-6">
                            <label for="simpleinput" class="form-label">Numéro de chèqu</label>
                            <input type="text" name="cheque_number" id="cheque_number2" class="form-control">
                        </div>
                    </div>

                    <div class="row">
                        <div class="mb-3 col-lg-6">
                            <label for="simpleinput" class="form-label">Facture concerné</label>
                            <input type="text" id="invoice_name2" class="form-control" required>
                            <input type="hidden" name="invoice_id" id="invoice_id2" class="form-control">
                        </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-6">
                            ...
                            <input class="form-control" id="date2" type="date" name="date">
                        </div>
