...
<form action="{{route('cashbox.ticket.update')}}" method="post" autocomplete="off" enctype="multipart/form-data">
    <div class="card my-3">
                ...
                <div class="col-md-6 col-12">
                    <div class="mb-3">
                        ...
                        <select class="form-select select2" data-toggle="select2" required id="expense_categorie_id"
                            ...
                            <option value="{{ $expense_categorie->id }}" {{$ticket->expense_category_id ==
                                $expense_categorie->id ? 'selected' : '' }}>{{ $expense_categorie->name }}</option>
                            @empty
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="ticket_file" id="example-fileinput"
                                                class="form-control dropify"
                                                data-default-file="{{$ticket ? Storage::url($ticket->ticket_file) : ''}}">
                                            <!-- $test_order ? Storage::url($test_order->examen_file) : ''!-->
                                ...
                                <div class="row d-flex align-items-end">
                                    <div class="col-md-4 col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="article-name" class="form-control"
                                                name="article_name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="row d-flex align-items-end">
                                                ...
                                                <div class="col-md-2 col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="line_amount" id="total"
                                        ...
                                        <div id="cardCollpase1" class="show collapse pt-3">
                                            ...
                                            {{-- <div class="row mx-3 mt-2">
                                                @if ($ticket->status == "en attente")
                                                <a type="submit" href="#" id="finalisationBtn"
                                                    class="btn btn-info disabled w-full">ENREGISTRER</a>
                                                @endif
                                            </div> --}}
                                            <div class="modal-footer">
                                                <button type="submit" {{$ticket->status != "en attente" ?
                                                    'disabled':''}} class="btn w-100 btn-success">Soumettre</button>
                                            </div>
                                        </div>
                            </form>
                            @endif
