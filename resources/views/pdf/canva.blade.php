...
<page backbottom="10mm">
    ...
    <div style="display: inline-block; margin-top:150px; margin-bottom: 20px;  left: 0; padding: 10px; text-align: left;">
        <p>
            <b>N° ANAPTH :</b> {{ $test_order_code }}
            <b>{{ $test_affiliate != null ? '| Examen reference : ' : '' }}</b>
            {{ $test_affiliate != null ? $test_affiliate : '' }}
    ...
    <div
        style="display: inline-block;  margin-top: 150px; margin-bottom: 20px; right: 0; width: 50px; padding: 10px; text-align: right;">
        <img src="{{ asset('storage/settings/app/' . $code .'_qrcode.png') }}" style="width: 65px;" alt="" srcset="">
    </div>
